...
// From https://github.com/newshadowk/NetRpc/blob/master/src/NetRpc.Http.Client/Helper/HttpWebRequestWrapper.cs
...
namespace NetRpc
{
    class Program
    {
        ...
        private class HttpWebRequestWrapper
        {
            ...
            public void WriteParameterAsync(NameValueCollection nvc)
            {
                ...
                foreach (string key in nvc.Keys)
                {
                    ...
                    _requestStream.Write(formItemBytes, 0, formItemBytes.Length);
            ...
            public void WriteStreamAsync(Stream fileStream, string fileStreamName)
            {
                //write stream header
                ...
                _requestStream.Write(headerBytes, 0, headerBytes.Length);

                Stream _requestStream2;
                _requestStream2 = _requestStream;

                //write stream body
                fileStream.CopyTo(_requestStream2);
                //await fileStream.CopyToAsync(_requestStream);
                fileStream.Close();
            }

            //public async Task WriteEndBoundaryAsync()
             public void WriteEndBoundaryAsync()
            {
                var trailer = Encoding.ASCII.GetBytes("\r\n--" + _boundary + "--\r\n");
                //  await _requestStream.WriteAsync(trailer, 0, trailer.Length);
                _requestStream.Write(trailer, 0, trailer.Length);
